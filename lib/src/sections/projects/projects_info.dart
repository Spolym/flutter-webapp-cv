// projects 1
final String projectsOneTitle = "General Electric Health Care - EEDP Intern";
final String projectsOneDesc =
    "At General Electric Healthcare, I developed a proof of concept for performing parallel reads of the HDF5 file format using included libraries to significantly reduce image reconstruction time. I worked in Linux to convert serial API's into parallel API's to increase the performance of interacting with HDF5, and implemented these parallel HDF5 methods into production code to enhance the performance of PETMR technology. In addition, I worked to identify the best hardware to run the next generation of PETMR machines, utilizing my expertise in hardware selection and optimization. This projects required a strong understanding of both software and hardware.";
final String projectsOneImg = "assets/logos/GEHC_logo.png";

// projects 2
final String projectsTwoTitle =
    "Michigan State University Engineering - Core Peer Leader";
final String projectsTwoDesc =
...
final String projectsTwoImg = "assets/logos/MSU_logo.png";

// projects 3
final String projectsThreeTitle =
    "Michigan State University Engineering IT - Student Tech. I";
final String projectsThreeDesc =
